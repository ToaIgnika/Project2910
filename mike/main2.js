...
function createPost(input1, input2, input3) {
	...
	var postKey = getNodeAt("active_posts/").push().key;
	
	// trying syntax from firebase documentation page
	var updates = {};
	updates["/active_posts/" + postKey] = postData;
	updates["/users/" + userKey + "/" + postKey] = postData;
